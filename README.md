...
Met afleveringen.py worden de URL's van afleveringen van specifiek geselecteerde NPO-programma's gemaakt en opgeslagen in een csv. Let op: NPO Start is een interactieve website, dus bij de kleinste aanpassingen aan de NPO-kant werkt het scrapen niet meer. De code zal ongetwijfeld aangepast moeten worden om 'm weer werkend te krijgen. afleveringen.py is gemaakt door Olaf van Waart.
